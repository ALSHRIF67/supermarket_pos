...
<div class="container mx-auto px-4 py-6 max-w-3xl">
    ...
    <form method="POST" action="{{ route('expenses.store') }}" class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
        @csrf
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="expense_name" id="expense_name" value="{{ old('expense_name') }}" 
                               class="w-full rounded-xl border-gray-200 border-2 focus:border-blue-600 focus:ring-0 transition-colors bg-gray-50/50 focus:bg-white px-4 py-2.5" 
                               placeholder="مثال: إيجار المحل، فواتير كهرباء..." required>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" step="0.01" name="amount" id="amount" value="{{ old('amount') }}" 
                                   class="w-full rounded-xl border-gray-200 border-2 focus:border-blue-600 focus:ring-0 transition-colors bg-gray-50/50 focus:bg-white px-4 py-2.5 text-left dir-ltr font-bold text-red-700" 
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" id="description" rows="3" 
                                  class="w-full rounded-xl border-gray-200 border-2 focus:border-blue-600 focus:ring-0 transition-colors bg-gray-50/50 focus:bg-white px-4 py-3"
                                  placeholder="أدخل أي تفاصيل إضافية عن المصروف...">{{ old('description') }}</textarea>
